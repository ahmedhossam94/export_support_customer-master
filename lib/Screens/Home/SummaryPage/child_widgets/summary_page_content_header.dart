...
class SummaryPageContentHeader extends StatelessWidget {
  SummaryPageContentHeader({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      child: Center(
          child: Text(
        localizations.translate(LocalizedKey.summaryScreenHeaderTitle),
        style: TextStyle(
